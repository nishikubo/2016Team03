...
public class Player2 : MonoBehaviour {
    ...
    void Move()
    {
        ...
        //moveDirection *= speed;
        //moveDirection.y += y;
        //moveDirection.y -= 9.8f * Time.deltaTime * mass;

        //controller.Move(moveDirection * Time.deltaTime);
        
        
        //Debug.Log(_rd.velocity);
        float x = Input.GetAxisRaw("Horizontal");
        float z = Input.GetAxisRaw("Vertical");
        moveDirection = new Vector3(x, 0, z).normalized;
        //moveDirection.y += y;
        //moveDirection *= speed;
        moveDirection.y -= 9.8f * mass;

        _rd.velocity = moveDirection*speed ;
        
        
        //float y = _rd.velocity.y;
        //y = 10 * speed;
        
        
        //_rd.position += direction * speed;
    ...
    void Jump()
    {
        _rd.AddForce(Vector3.up * jumpPower, ForceMode.Impulse);
